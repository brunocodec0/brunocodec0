...
Estudante de Administração na **UERJ** com foco em dados, automação e produtos digitais com IA.
Construo ferramentas que resolvem problemas reais — de SaaS a automações no WhatsApp.
...
|---|---|---|
| [DecisionLab AI](https://github.com/brunocodec0/Decision-Lab) | SaaS de apoio à decisão estratégica com IA | Next.js · Supabase · Claude API |
...
| [Gancho](https://github.com/brunocodec0/gancho) | SaaS de geração diária de conteúdo para criadores com IA | Next.js · Supabase · Claude API |
...
[![Gmail](https://img.shields.io/badge/Gmail-EA4335?style=flat&logo=gmail&logoColor=white)](mailto:brunocodeco7@gmail.com)
